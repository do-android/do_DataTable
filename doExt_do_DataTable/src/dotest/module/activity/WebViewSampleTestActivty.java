...
import doext.implement.do_DataTable_Model;
import doext.implement.do_DataTable_View;
...
public class WebViewSampleTestActivty extends DoTestActivity {
	...
	protected void initModuleModel() throws Exception {
		this.model = new do_DataTable_Model();
	}

	@Override
	protected void initUIView() throws Exception {
		do_DataTable_View view = new do_DataTable_View(this);
		...
		uiview.addView(view,new LinearLayout.LayoutParams(-1, -1));
	}
	...
	protected void doTestSyncMethod() {
		...
		_paras_back.put("data", "[['1','aaa'],['2','bbb']]");
		DoService.syncMethod(this.model, "setRowData", _paras_back);
	}
